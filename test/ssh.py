import paramiko, sys, getpass, os, threading
...
if __name__ == '__main__':
    ...
    with open(fname) as obj:
        ips = [line.strip() for line in obj]

    for i in ips:
        t = threading.Thread(target=remote_comm, args=(i, pwd, command))
        t.start()
        # remote_comm(fname, command, pwd)
